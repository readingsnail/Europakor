...
class YmlConvertSupporter(object) :
    def __init__(self) :
        ...
        try :
            ## print("Current directory : " + os.getcwd()+"\\HOI4KR_Pro2Yml_config.ini")
            _configfile = open("HOI4KR_Pro2Yml_config.ini" , 'r', encoding='UTF-8' )
            self.config.read("HOI4KR_Pro2Yml_config.ini", encoding='UTF-8' ) ## this one recieves name of file
            self.noconfig = False
            _configfile.close()
        ...
        if self.noconfig == True :
            with open("Default.ini", "w") as configfile :
                ...
                configfile.close()
                print("Default.ini file creadted")
